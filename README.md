...
2294 | [Partition Array Such That Maximum Difference Is K](https://leetcode.com/problems/partition-array-such-that-maximum-difference-is-k/description/) | [Java](./MatrixGrids/partition_array_such_that_maximum_difference_is_k.java) | _O(n log n)_ | _O(log n)_ | Medium || Sorting, Greedy
