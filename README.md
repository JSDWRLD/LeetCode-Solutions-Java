...
79 | [Word Search](https://leetcode.com/problems/word-search/description/) | [Java](./MatrixGrids/word_search.java) | _O(r * c * w^4)_ | _O(1)_ | Medium || Matrix, Backtracking, Graph Depth-First Search
