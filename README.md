...
1532 | [Count Odd Numbers in an Interval Range](https://leetcode.com/problems/count-odd-numbers-in-an-interval-range/description/) | [Java](./Math/count_odd_numbers_in_a_interval_range.java) | _O(1)_ | _O(1)_ | Easy || Math
