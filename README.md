...
1456 | [Maximum Number of Vowels in a Substring of Given Length](https://leetcode.com/problems/maximum-number-of-vowels-in-a-substring-of-given-length/) | [Java](./Arrays/maximum_number_of_vowels_in_a_substring_of_given_length.java) | _O(n)_ | _O(1)_ | Medium || Sliding Window
1470 | [Shuffle the Array](https://leetcode.com/problems/shuffle-the-array/description/) | [Java](./Arrays/shuffle_the_array.java) | _O(n)_ | _O(n)_ | Easy || Arrays
...
1498 | [Number of Subsequences That Satisfy the Given Sum Condition](https://leetcode.com/problems/number-of-subsequences-that-satisfy-the-given-sum-condition/description/) | [Java](./Arrays/number_of_subsequences_that_satisfy_the_given_sum_condition.java) | _O(n log n)_ | _O(n)_ | Medium || Two Pointers, Sorting
...
2529 | [Maximum Count of Positive Integers and Negative Integers](https://leetcode.com/problems/maximum-count-of-positive-integer-and-negative-integer/description/) | [Java](./Arrays/maximum_count_of_positive_integers_and_negative_integers.java) | _O(n)_ | _O(1)_ | Easy || Arrays
...
3318 | [Find X-Sum Long Subarrays I](https://leetcode.com/problems/find-x-sum-of-all-k-long-subarrays-i/description/) | [Java](./Arrays/find_x-sum_long_subarrays_i.java) | _O(n * klogk)_ | _O(k)_ | Easy || Math, HashMap
...
3408 | [Design Task Manager](https://leetcode.com/problems/design-task-manager/description/) | [Java](./Arrays/design_task_manager.java) | _O(n log n)_ | _O(n)_ | Medium || HashMap, Priority Queue
...
2125 | [Number of Laser Beams in a Bank](https://leetcode.com/problems/number-of-laser-beams-in-a-bank/description/) | [Java](./MatrixGrids/number_of_laser_beams_in_a_bank.java) | _O(n*m)_ | _O(1)_ | Medium || Math, Matrix
2192 | [All Ancestors of Node in a Directed Acyclic Graph](https://leetcode.com/problems/all-ancestors-of-a-node-in-a-directed-acyclic-graph/description/) | [Java](./MatrixGrids/all_ancesotrs_of_a_node_in_a_directed_acyclic_graph.java) | _O(v^2 + e)_ | _O(v^2 + e)_ | Medium || Topological Sort
...
966 | [Vowel Spellchecker](https://leetcode.com/problems/vowel-spellchecker/description/) | [Java](./Maps/vowel_spellchecker.java) | _O(c * l)_ | _O(c * l)_ | Medium || HashSet, HashMap
...
1347 | [Minimum Number of Steps to Make Two Strings Anagram](https://leetcode.com/problems/minimum-number-of-steps-to-make-two-strings-anagram/description/) | [Java](./Strings/minimum_number_of_steps_to_make_two_strings_anagram.java) | _O(n)_ | _O(1)_ | Medium || Strings
1358 | [Number of Substrings Containing All Three Characters](https://leetcode.com/problems/number-of-substrings-containing-all-three-characters/description/) | [Java](./Strings/number-of-substrings-containing-all-three-characters.java) | _O(n)_ | _O(1)_ | Medium || Strings, Sliding Window
...
1935 | [Maximum Number of Words You Can Type](https://leetcode.com/problems/maximum-number-of-words-you-can-type/) | [Java](./Strings/maximum_number_of_words_you_can_type.java) | _O(n+b)_ | _O(n+b)_ | Easy || HashSet
...
2138 | [Divide a String Into Groups of Size k](https://leetcode.com/problems/divide-a-string-into-groups-of-size-k/description/) | [Java](./Strings/divide_a_string_into_groups_of_size_k.java) | _O(n)_ | _O(n)_ | Easy || Strings
...
2211 | [Count Collisions on a Road](https://leetcode.com/problems/count-collisions-on-a-road/description/) | [Java](./Strings/count_collisions_on_a_road.java) | _O(n)_ | _O(1)_ | Medium || String, Math
...
2785 | [Sort Vowels in a String](https://leetcode.com/problems/sort-vowels-in-a-string/description/) | [Java](./Strings/sort_vowels_in_a_string.java) | _O(n log n)_ | _O(n)_ | Medium || Sorting
...
3006 | [Find Beautiful Indices in the Given Array I](https://leetcode.com/problems/find-beautiful-indices-in-the-given-array-i/) | [Java](./Strings/find_beautiful_indices_in_the_given_array_i.java) | _O(n)_ | _O(n)_ | Medium || Two Pointers
...
3227 | [Vowels Game in a String](https://leetcode.com/problems/vowels-game-in-a-string/description/) | [Java](./Strings/vowels_game_in_a_string.java) | _O(n)_ | _O(1)_ | Medium || Brain Teaser
...
3412 | [Find Mirror Score of a String](https://leetcode.com/problems/find-mirror-score-of-a-string/description/) | [Java](./Strings/find_the_mirror_score_of_a_string.java) | _O(n)_ | _O(n)_ | Medium || HashMap
...
430 | [Flatten a Multilevel Doubly Linked List](https://leetcode.com/problems/flatten-a-multilevel-doubly-linked-list/) | [Java](./LinkedLists/flatten_a_multilevel_doubly_linked_list.java) | _O(n)_ | _O(n)_ | Medium || Depth-First Search, Doubly-Linked List
...
958 | [Check Completeness of a Binary Tree](https://leetcode.com/problems/check-completeness-of-a-binary-tree/description/) | [Java](./Trees/check_completeness_of_a_binary_tree.java) | _O(n)_ | _O(n)_ | Medium || Tree, Breadth-First Search
...
1214 | [Two Sum BSTs](https://leetcode.com/problems/two-sum-bsts/description/) | [Java](./Trees/two_sum_bsts.java) | _O(n + log(m))_ | _O(n)_ | Medium || Tree, Set
...
1317 | [Convert Integer to the Sum of Two No-Zero Integers](https://leetcode.com/problems/convert-integer-to-the-sum-of-two-no-zero-integers/description/) | [Java](./Math/convert_integer_to_the_sum_of_two_no-zero_integers.java) | _O(n * k)_ | _O(1)_ | Easy || Math
...
1523 | [Count Odd Numbers in an Interval Range](https://leetcode.com/problems/count-odd-numbers-in-an-interval-range/description/) | [Java](./Math/count_odd_numbers_in_a_interval_range.java) | _O(1)_ | _O(1)_ | Easy || Math
...
2582 | [Pass the Pillow](https://leetcode.com/problems/pass-the-pillow/description/) | [Java](./Math/pass_the_pillow.java) | _O(1)_ | _O(1)_ | Easy || Math
...
1526 | [Minimum Number of Increments on Subarrays to Form a Target Array](https://leetcode.com/problems/minimum-number-of-increments-on-subarrays-to-form-a-target-array/description/) | [Java](./DynamicProgramming/minimum_number_of_increments_on_subarrays_to_form_a_target_array.java) | _O(n)_ | _O(1)_ | Medium || Greedy, Bottom Up
...
2327 | [Number of People Aware of a Secret](https://leetcode.com/problems/number-of-people-aware-of-a-secret/description/) | [Java](./DynamicProgramming/number_of_people_aware_of_a_secret.java) | _O(n)_ | _O(n)_ | Medium || Bottom-Up DP
...
3186 | [Maximum Total Damage With Spell Casting](https://leetcode.com/problems/maximum-total-damage-with-spell-casting/description/) | [Java](./DynamicProgramming/maximum_total_damage_with_spell_casting.java) | _O(n log n)_ | _O(n)_ | Medium || Dynamic Programming, Sorting
